...
public partial class GameEntity {
    ...
    public CodeBase.Components.DirectionComponent direction { get { return (CodeBase.Components.DirectionComponent)GetComponent(GameComponentsLookup.Direction); } }
    public bool hasDirection { get { return HasComponent(GameComponentsLookup.Direction); } }

    public void AddDirection(UnityEngine.Vector3 newDirection, float newSpeed) {
        var index = GameComponentsLookup.Direction;
        var component = (CodeBase.Components.DirectionComponent)CreateComponent(index, typeof(CodeBase.Components.DirectionComponent));
        component.Direction = newDirection;
        component.Speed = newSpeed;
        AddComponent(index, component);
    }

    public void ReplaceDirection(UnityEngine.Vector3 newDirection, float newSpeed) {
        var index = GameComponentsLookup.Direction;
        var component = (CodeBase.Components.DirectionComponent)CreateComponent(index, typeof(CodeBase.Components.DirectionComponent));
        component.Direction = newDirection;
        component.Speed = newSpeed;
